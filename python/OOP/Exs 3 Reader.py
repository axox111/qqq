class Reader:
    ...
    def __init__(self, fullName, ticketNumber, faculty, birthDate, phoneNumber):
    ...
    #     if isinstance(returnBooks, str):
    #         print(f"{self.fullName} вернул{returnBooks}")
    #     if isinstance(returnBooks, Book):
